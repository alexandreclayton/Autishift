...
<div class="header-top ">
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          <h1>Bem vindo ao Autishift</h1>
          <h2>Sua Plataforma de Integração TEA</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-stretch">
            <div class="content">
              <h3>A Autishift é uma plataforma de integração</h3>
              <p>
                especialmente criada para o auxiliar o desenvolvimento de portadores do espectro autista
              </p>
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Seja um parceiro do Autishift.</p>
        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Endereço</h3>
                  <p>Rua da Soledade 1000,Recife - PE</p>
                </div>
              </div>
              <div class="col-md-6">
